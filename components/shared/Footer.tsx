    ...
    return (
        <section className='bg-second' id='contact'>
            <div className='max-w-[1320px] md:mx-auto mx-4 py-20'>
                ...
                <div className='flex items-center justify-center flex-col pt-16 text-white font-inter'>
                    <h3><strong>UI Design by misbachulumam</strong> - licensed under </h3>
                    <h3>https://creativecommons.org/licenses/by/4.0/</h3>
                </div>
            </div>
        </section>
    )
